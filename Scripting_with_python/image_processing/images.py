...
# img = Image.open(r'C:\Users\Isaac Alexander\Desktop\images')
img1 = Image.open('imagejpg/4.1 bulbasaur.jpg')
# img2 = Image.open('images/4.3 pikachu.jpg')
# img3 = Image.open('images/4.4 charmander.jpg')
# img4 = Image.open('images/4.3 squirtle.jpg')
#
